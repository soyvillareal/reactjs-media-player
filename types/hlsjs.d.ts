// Type definitions for hls.js 1.5.7
// Project: https://github.com/video-dev/hls.js
// Definitions by: Video Dev <https://github.com/video-dev>
// Definitions: https://github.com/video-dev/hls.js/blob/master/src/controller/abr-controller.ts
...
declare namespace hlsjs {
  ...
  class BasePlaylistController implements NetworkComponentAPI {
    protected hls: Hls;
  ...
  class BufferController implements ComponentAPI {
    private details;
    private _objectUrl;
  ...
  class ContentSteeringController implements NetworkComponentAPI {
  ...
  const enum ElementaryStreamTypes {
    AUDIO = 'audio',
    VIDEO = 'video',
  ...
  class ErrorController implements NetworkComponentAPI {
    private readonly hls;
  ...
  const enum PlaylistContextType {
    MANIFEST = 'manifest',
    LEVEL = 'level',
  ...
  interface SubtitleFragProcessed {
    success: boolean;
    frag: Fragment;
  }
